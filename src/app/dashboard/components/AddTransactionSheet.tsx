      ...
      footer={
        <div className="flex gap-3">
          <button
            ...
            disabled={isPending || !selectedAccount || (type === "expense" && !selectedCategory) || (type === "income" && !selectedCategory) || (type === "transfer" && !selectedToAccount)}
          ...
          <button type="button" onClick={onClose} className="flex-1 py-3 rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-sm font-semibold transition">
            Cancel
          </button>
        </div>
      }
    >
      <form id="add-transaction-form" ref={formRef} onSubmit={handleSubmit} className="px-4 py-4 space-y-4 overflow-y-auto flex-1">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl overflow-hidden">
          ...
          <div className="flex items-center px-4 h-14 border-b border-gray-100 dark:border-gray-800">
            <span className="text-sm text-gray-500 dark:text-gray-400 w-24 shrink-0">Amount</span>
          ...
          <button type="button" onClick={() => setShowAccountPicker(true)}
            ...
            <span className={`flex-1 text-sm text-right mr-2 ${selectedAccount ? "text-gray-900 dark:text-white" : "text-gray-400 dark:text-gray-500"}`}>
          ...
          {type === "transfer" && (
            <button type="button" onClick={() => setShowToAccountPicker(true)}
              className="w-full flex items-center px-4 h-14 border-b border-gray-100 dark:border-gray-800 text-left">
              <span className="text-sm text-gray-500 dark:text-gray-400 w-24 shrink-0">To</span>
              <span className={`flex-1 text-sm text-right mr-2 ${selectedToAccount ? "text-gray-900 dark:text-white" : "text-gray-400 dark:text-gray-500"}`}>
                {selectedToAccount ? selectedToAccount.name : "Select *"}
              </span>
              <ChevronRight className="h-4 w-4 text-gray-300 dark:text-gray-600 shrink-0" />
            </button>
          )}
          ...
          <button type="button" onClick={() => setShowDatePicker(true)}
            className="w-full flex items-center px-4 h-14 border-b border-gray-100 dark:border-gray-800 text-left">
            <span className="text-sm text-gray-500 dark:text-gray-400 w-24 shrink-0">Date</span>
            <span className="flex-1 text-sm text-right mr-2 text-gray-900 dark:text-white">
          ...
          <div className="flex items-center px-4 h-14">
            <span className="text-sm text-gray-500 dark:text-gray-400 w-24 shrink-0">Note</span>
            <input
